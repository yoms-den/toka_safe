...
class CreateAndUpdate extends ModalComponent
{
    ...
    public function mount(IncidentReport $incident, EventParticipants $participan)
    {
        $this->data_id = $incident->id;
        $this->event_type_id = $incident->event_type_id;
        $this->sub_event_type_id = $incident->sub_event_type_id;
    ...
    public function render()
    {
        ...
        $this->updatePanel();
        return view('livewire.event-report.incident-report.event-partisipan.create-and-update', [
    ...
    public function store()
    {
        ...
        $this->dispatch('eventParticipanIncident_created');
    }
     /**
