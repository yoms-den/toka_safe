<div>
    <form wire:submit.prevent='store'>
        @csrf
        @method('PATCH')
        <div wire:target="store" wire:loading.class="skeleton" class="p-2 my-1 text-xs border rounded-sm border-slate-300">
            <div class=" w-72">
                ...
                <div class="flex justify-between gap-x-1">
                    ...
                    <div class="grow">
                        <span
                            class="bg-clip-text font-semibold italic text-transparent {{ $bg_status }}">{{ $status }}</span>
                    </div>
                </div>
            </div>
