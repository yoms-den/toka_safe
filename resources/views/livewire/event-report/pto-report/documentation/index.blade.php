                        ...
                        <td>
                            <div class="flex items-center gap-3">
                                <div wire:click="download('{{ $item->id }}')" class="cursor-pointer avatar">
                                    ...
                                    @elseif(pathinfo(public_path($item->new_data['name_doc']))['extension'] === 'png' ||
                                            pathinfo(public_path($item->new_data['name_doc']))['extension'] === 'jpeg' ||
                                ...
                                <div>
                                    <div class="font-bold">{{ $item->new_data['name_doc'] }}</div>
                                    <div class="text-sm opacity-50">
                                        {{ pathinfo(public_path($item->new_data['name_doc']))['extension'] }}</div>
                                </div>
                            </div>
                        </td>
                        <td>
