<label
    ...
    <svg version="1.1" id="Uploaded to svgrepo.com" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" class="size-5 ml-[5%] mt-[5%]" viewBox="0 0 32 32" xml:space="preserve">
        <style type="text/css">
            .pictogram_zes {
                fill: #0C6667;
            }
        ...
        <g>
            ...
            <path class="pictogram_vijf"
                d="M16,0v4c6.627,0,12,5.373,12,12c0,6.627-5.373,12-12,12v4c8.837,0,16-7.163,16-16S24.837,0,16,0z" />
            <path class="pictogram_vijf"
                d="M16,0v4c6.627,0,12,5.373,12,12c0,6.627-5.373,12-12,12v4c8.837,0,16-7.163,16-16S24.837,0,16,0z" />
